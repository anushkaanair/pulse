      ...
      <div className="max-w-7xl mx-auto px-4 h-12 flex items-center gap-2.5">
        <Link href="/" className="flex items-center gap-2">
          <span
            ...
            style={{ background: "linear-gradient(140deg, var(--accent-2), var(--accent))", boxShadow: "0 3px 10px -3px color-mix(in srgb, var(--accent) 60%, transparent), inset 0 1px 0 rgba(255,255,255,.35)" }}
          >
